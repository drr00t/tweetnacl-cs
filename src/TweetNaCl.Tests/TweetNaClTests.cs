...
namespace NaCl.Tests
{
    ...
    public class TweetNaClTests
    {
        ...
        public void TestForMessageEncryptionWithCryptoBoxBeforenm()
        {
            ...
            Assert.AreEqual(k.Length, TweetNaCl.BOX_BEFORENMBYTES,"generation of K for encryption failed.");
        }
        ...
        public void TestForMessageEncryptionWithCryptoBoxAfternm()
        {
            ...
            result = TweetNaCl.CryptoBoxAfternm(encMessage, paddedMessage, nonce, k);
        ...
        public void TestForMessageEncryptionWithCryptoBoxOpenAfternm()
        {
            ...
            var k = TweetNaCl.CryptoBoxBeforenm(pk, sk);
            Assert.AreEqual(k.Length, TweetNaCl.BOX_BEFORENMBYTES, "K generation for encryption failed.");

            result = TweetNaCl.CryptoBoxAfternm(encMessage, paddedMessage, nonce, k);
            Assert.AreNotEqual(result, -1, "encryption failed.");

            result = TweetNaCl.CryptoBoxOpenAfternm(decMessage, encMessage, nonce, k);
        ...
        public void TestForMessageEncryption()
        {
            ...
            TweetNaCl.CryptoBox(encMessage, paddedMessage, nonce, pk, sk);
            Assert.AreNotEqual(result, -1, "encryption failed.");
        }
        ...
        public void TestForMessageDecryptionDifferentKeyPair()
        {
            ...
            Assert.AreEqual(Encoding.ASCII.GetString(apk).Length, 32, "key generation failed.");

            bpk = TweetNaCl.CryptoBoxKeypair(bsk);
            Assert.AreEqual(Encoding.ASCII.GetString(bpk).Length, 32, "key generation failed.");
        ...
        public void TestForMessageDecryptionSecretBox()
        {
            ...
            var result = TweetNaCl.CryptoSecretBox(encMessage, paddedMessage, nonce, sk);
            Assert.AreNotEqual(result, -1, "encryption failed.");

            result = TweetNaCl.CryptoSecretBoxOpen(decMessage, encMessage, nonce, sk);
            Assert.AreNotEqual(result, -1, "decryption failed.");
        }
        ...
        public void TestForMessageSign()
        {
            ...
            Assert.AreEqual(Encoding.ASCII.GetString(sMessage).Length, bMessage.Length + TweetNaCl.SIGN_BYTES, "Message sign failed.");
        }
        ...
        public void TestForMessageSignOpen()
        {
            ...
            var spk = TweetNaCl.CryptoSignKeypair(ssk);
            sMessage = TweetNaCl.CryptoSign(bMessage, ssk);
            Assert.AreEqual(sMessage.Length, bMessage.Length + TweetNaCl.SIGN_BYTES, "Message sign failed.");
